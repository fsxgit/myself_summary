...
function pageLoad() {
    ...
    $("header .menu li,.ceNav p").bind("click touchstart",
        function() {
    ...
    videoSwiper = new Swiper(".video .swiper-container", {
        ...
        onSlideChangeStart: function() {
            $(".bannerImg2").removeClass("bounceInLeft").hide();
            $(".learnMore").removeClass("bounceInRight");
            $(".learnMore").css("opacity","0");
            $(".bannerCont1").removeClass("bounceInDown").hide();
            resetVideoSwiperAnimation()
        },
        onSlideChangeEnd: function() {
            $(".bannerImg2").addClass("bounceInLeft").show();
            $(".learnMore").addClass("bounceInRight");
            $(".learnMore").css("opacity","1");
            $(".video .guide a").removeClass("active").eq(videoSwiper.activeLoopIndex).addClass("active");
            $(".bannerCont1").addClass("bounceInDown").show();
    ...
    $(".contact .box").append('<div class="below"><i></i><p style="margin-top:20px;">Copyright © 2011-2014 iHope99.com All Rights Reserved 版权所有 · 北京海博远创软件科技有限公司 京ICP备11043388号</p></div>');
...
function huifu(){
    ...
    $(".ser-box li,.sec3-h1,.sec5-h1,.sec5-h3,.team-box li,.pai-box p,.sec2-h1,.sec2-h3,.pai-img,.jiej-box li,.sec4-h1,.sec4-h3,.sec6-h1,.sec6-h3,.sec7-h1,.sec7-h3").css("opacity","0");
    //pageIndex == 0
    ...
    $(".sec2-h1").removeClass("fadeInDown");
    $(".sec2-h3").removeClass("fadeInDown");
    $("pai-img").removeClass("fadeInDown");
    $(".pai-box p").removeClass("bounceInLeft");
    //pageIndex == 2
    $(".sec3-h1").removeClass("fadeInDown");
    $(".ser-box li").removeClass("fadeInUp");

    //pageIndex == 3

    $(".jiej-box li:not('.li2')").removeClass("bounceInDown");
    $(".jiej-box .li2").removeClass("bounceInUp");
    $(".sec4-h1").removeClass("bounceInLeft");
    $(".sec4-h3").removeClass("bounceInRight");
    //pageIndex == 4
    $(".sec5-h1").removeClass("fadeInDown");
    $(".team-box .li1").removeClass("bounceInLeft");
    $(".team-box .li2").removeClass("bounceInRight");

    //pageIndex == 5

    $(".sec6-h1").removeClass("fadeInDown");
    $(".sec6-h3").removeClass("fadeInDown");
    //pageIndex == 6

    $(".sec7-h1").removeClass("fadeInDown");
    $(".sec7-h3").removeClass("fadeInDown");
    $(".lcImg").removeClass("scaleD");
}
...
function sectionAnimation() {
    ...
    if (pageIndex == 1) {
        $(".pai-img").animate({"opacity":"1"},800)
        $(".pai-box .pf1,.sec2-h1,.sec2-h3").css("opacity","1");
        $(".pai-box .pf1").addClass("bounceInLeft");
        $(".sec2-h1").addClass("fadeInDown");
        $(".sec2-h3").addClass("fadeInDown");
        setTimeout(function(){
            $(".pai-box .pf2").addClass("bounceInLeft");
            $(".pai-box .pf2").css("opacity","1");
        },200)
        setTimeout(function(){
            $(".pai-box .pf3").addClass("bounceInLeft");
            $(".pai-box .pf3").css("opacity","1");
        },400)
        setTimeout(function(){
            $(".pai-box .pf4").addClass("bounceInLeft");
            $(".pai-box .pf4").css("opacity","1");
        },600)
        setTimeout(function(){
            $(".pai-box .pf5").addClass("bounceInLeft");
            $(".pai-box .pf5").css("opacity","1");
        },800)
        setTimeout(function(){
            $(".pai-box .pf6").addClass("bounceInLeft");
            $(".pai-box .pf6").css("opacity","1");
        },1000)
        setTimeout(function(){
            $(".pai-box .pf7").addClass("bounceInLeft");
            $(".pai-box .pf7").css("opacity","1");
        },1200)
    ...
    if (pageIndex == 2) {
        $(".ser-box li,.sec3-h1").css("opacity","1");
        $(".ser-box li").addClass("fadeInUp");
        $(".sec3-h1").addClass("fadeInDown");
    } else {
        if (pageIndex == 3) {
            $(".jiej-box li").css("opacity","1");
            $(".jiej-box li:not('.li2')").addClass("bounceInDown");
            $(".jiej-box .li2").addClass("bounceInUp");
            setTimeout(function(){
                $(".sec4-h1,.sec4-h3").css("opacity","1");
                $(".sec4-h1").addClass("bounceInLeft");
                $(".sec4-h3").addClass("bounceInRight");
            },1000)
        } else {
            if (pageIndex == 4) {
                $(".team-box li,.sec5-h1").css("opacity","1");
                $(".sec5-h1").addClass("fadeInDown");
                $(".team-box .li1").addClass("bounceInLeft");
                $(".team-box .li2").addClass("bounceInRight");
                $(".sec5-h1").on("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
                    $(".sec5-h3").animate({"opacity":"1"},300);
                });
            }else{
                if(pageIndex == 5){
                    $(".sec6-h1,.sec6-h3").css("opacity","1");
                    $(".sec6-h1").addClass("fadeInDown");
                    $(".sec6-h3").addClass("fadeInDown");
                }else{
                    if(pageIndex == 6){
                        $(".sec7-h1,.sec7-h3").css("opacity","1");
                        $(".sec7-h1").addClass("fadeInDown");
                        $(".sec7-h3").addClass("fadeInDown");
                        $(".lcImg").addClass("scaleD");
                    }
                }
            }
        }
...
function pageSwitching() {
    ...
    if(pageIndex <= 6){
        ...
        $(".ceNav p").removeClass("active").eq(pageIndex).addClass("active");
        $("header .menu").trigger("mouseleave")
    }
    }
