...
function sucFun(j){
	...
	switch(j){
		case 0:
			console.log("000");
			//添加的
			$(".first h1").addClass("bounceInDown");
			$(".first .weltxt").addClass("bounceInLeft");
			$(".first .welman").addClass("bounceInRight");
			//移除的
			$(".second .xk-box").removeClass("bounceInLeft");
			$(".third h1").removeClass("fadeInDown");
			$(".third .ul-pet").removeClass("fadeInUp");

			break;
		case 1:
			console.log("111");
			//添加的
			$(".second .xk-box").addClass("bounceInLeft");
			//移除的
			$(".first h1").removeClass("bounceInDown");
			$(".first .weltxt").removeClass("bounceInLeft");
			$(".first .welman").removeClass("bounceInRight");
			$(".third h1").removeClass("fadeInDown");
			$(".third .ul-pet").removeClass("fadeInUp");
		...
		case 2:
			console.log("222");
			//添加的
			$(".third h1").addClass("fadeInDown");
			$(".third .ul-pet").addClass("fadeInUp");
			//移除的
			$(".first h1").removeClass("bounceInDown");
			$(".first .weltxt").removeClass("bounceInLeft");
			$(".first .welman").removeClass("bounceInRight");
