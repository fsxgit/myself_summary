	...
	$.fn.smint = function( options ) {
		...
		return $('.smint a').each( function(index) {
			...
			var stickyMenu = function(direction){
				...
				// if we scroll more than the navigation, change its position to fixed and add class 'fxd', otherwise change it back to absoalert(scrollTop);
        	...
        	$(this).on('click', function(e){
				...
				var navbarHeight = $(".fx-navHeight").height();
				var goTo = null;
				if ( id == "s1")
				{
					goTo =  $('div.'+ id).offset().top ;
					//alert("111");
				}else{
					goTo =  $('div.'+ id).offset().top - navbarHeight+2;
					//alert("222");
				}
...
//$(function() {
//	var oTop = $(".fxTop").height();
//	var oNavTop = $(".fxNavTop");
//	$(document).ready(function () {
//		oNavTop.css({top: oTop});
//		alert(oTop);
//	})
//});