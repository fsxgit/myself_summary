    ...
    (function () {
        ...
        function k(b, a) {
            ...
            this.resizeTo = function (a) {
                if (0 === this.x && 0 === this.y) this._length = 0; else if (0 === this.x) this._length = a, this.y = a * c(this.y); else if (0 === this.y) this._length = a, this.x = a * c(this.x); else {
        ...
        var w = function (b, a) {
            ...
            if (1 < a) {
                ...
                if (f.getLength() > this.lineCurveThreshold) {
                    ...
                    var u = (new k(f.x + d.x, f.y + d.y)).reverse().resizeTo(Math.max(.05, q) * n),
                        f = this.canvasContext, n = m.x, q = m.y, p = c.x, A = c.y, r = m.x + l.x, m = m.y + l.y;
                    l = c.x + u.x;
                    u = c.y + u.y;
                    f.beginPath();
                    f.moveTo(n, q);
            ...
            if (0 < a) {
                ...
                if (d.getLength() > this.lineCurveThreshold) if (1 < a) {
                    ...
                    var f = (new k(b.x + d.x, b.y + d.y)).resizeTo(d.getLength() / 2), d = this.canvasContext;
                    b = e.x;
        ...
        function t(f, d) {
            ...
            this.resizeTo = function (a) {
                if (0 === this.x && 0 === this.y) this._length = 0; else if (0 === this.x) this._length = a, this.y = a * b(this.y); else if (0 === this.y) this._length = a, this.x = a * b(this.x); else {
                    var c = Math.abs(this.y / this.x), d = Math.sqrt(Math.pow(a, 2) / (1 + Math.pow(c, 2))), c = c * d;
                    this._length = a;
                    this.x = d * b(this.x);
                    this.y = c * b(this.y)
                }
