...
CalendarWidget.initialize = function (o) {
    ...
    var currentYear = parseInt(o.currentYear || now.getFullYear()),
        ...
        startYear = parseInt(o.startYear || 1900), //设定开始的年份1
        endYear = parseInt(o.endYear || now.getFullYear()),  //设定结束的年份
        //endYear = 2688,  //也可以自定义设定结束的年份
        input = o.input;
