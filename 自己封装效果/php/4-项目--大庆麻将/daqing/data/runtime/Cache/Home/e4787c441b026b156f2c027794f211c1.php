...
<form action="<?php echo U('');?>" method="post">
    <div class="register-box oh">
        ...
        <div class="login_input_ts ts3"><span class="ts" >账号格式不正确</span></div>
        <div class="login_input"><input type="password" class="pass" name="password" placeholder="请输入6-12位字符或数字的密码"/></div>
        <div class="login_input_ts ts4"><span class="ts" >密码格式不正确</span></div>
        <div class="login_txt2">实名及防沉迷填写</div>
        <div class="login_input">
            <input type="text" id="realname" class="realname"  name="realname" placeholder="请输入真实姓名"/>
        </div>
        <div class="login_input_ts ts1"><span class="ts" >请输入正确的姓名</span></div>
        <div class="login_input"><input type="text" class="idcard"  name="idcard" placeholder="请输入正确的身份证号"/></div>
        <div class="login_input_ts ts2"><span class="ts" >请输入正确身份证号</span></div>
        <div class="choose_xy">
            <span class="xy_btn"></span><span>我已仔细阅读并接受 <a href="<?php echo U('Home/Index/xy1');?>">《用户服务协议》</a></span>
        </div>
        <div class="choose_xy">
            <span class="xy_btn"></span><span>我已仔细阅读并接受
            <a href="<?php echo U('Home/Index/xy2');?>">《网络游戏防沉迷协议及实名认证服务协议》</a>
        </span>
        </div>
