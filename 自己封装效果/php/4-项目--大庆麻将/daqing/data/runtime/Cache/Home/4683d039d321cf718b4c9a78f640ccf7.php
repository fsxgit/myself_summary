...
<div class="bfff pt30 pb40">
    <div class="in-box main">
        <div class="in-top">
            <div class="in-top-left">
                <div class="hb-tit bb">
                    ...
                    <span class="tit">手机游戏下载</span>
                    <a class="more" href="<?php echo U('Home/Index/product');?>">更多</a>
                </div>
                <div class="in-down oh">
                    <div class="fl"><img src="/static/images/app.png" alt=""/></div>
                    <div class="down-right fl">
                    <p>大庆盘锦麻将</p>
                    <a class="hover1" href="https://fir.im/e4fj">下载</a>
                    </div>
                </div>
            </div>
            <div class="in-top-right">
                <div class="hb-tit bb">
                    ...
                    <a class="more" href="<?php echo U('Home/Index/introduce');?>">更多</a>
                </div>
                <div class="js-box">
                    <div class="js-left">
                        <img src="/static/images/logo2.png" alt=""/>
                        <p class="userq"><a class="hover2" href="<?php echo U('Home/Index/xy3');?>">用户权益保障</a></p>
                    </div>
                    <div class="js-right">
                        <h2>优世网络科技</h2>
        ...
        <div class="jzjh_box">
            <h1>家长监护</h1>
            <div class="jzjh_more"><a class="more" href="<?php echo U('Home/Index/custody');?>">更多</a></div>
            <div class="txt"><span class="upyin"></span><span class="downyin"></span>网络游戏未成年人家长监护工程”是一项由日月游戏平台根据国家有关规定而发起的一个项目，由中华人民共和国文化部指导，旨在加强家长对未成年人参与网络游戏的监护，引导未成年人健康、绿色参与网络游戏，和谐家庭关系的社会性公益行动。它提供了一种切实可行的方法，一种家长实施监控的管道，使家长纠正部分未成年子女沉迷游戏的行为成为可能。该项社会公益行动充分反映了中国网络游戏行业高度的社会责任感，对未成年玩家合法权益的关注及对用实际行动营造和谐社会的愿望。</div>
        </div>
    </div>
</div>
