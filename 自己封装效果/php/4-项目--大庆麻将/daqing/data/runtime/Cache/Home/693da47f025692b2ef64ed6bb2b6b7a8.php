...
<?php }else{ ?>
	<a class="lgsuc" href="javascrpt:;">你好,<?php echo ($user["username"]); ?></a> <a href="<?php echo U('Home/register/loginout');?>">退出</a> 
<?php } ?>
    ...
    <div class="in-box main">
            ...
            <div class="in-top-right">
                ...
                <div class="js-box">
                    <div class="js-left">
                        ...
                        <p class="userq"><a href="<?php echo U('Home/Index/xy3');?>">用户权益保障</a></p>
                    </div>
                    <div class="js-right">
                        <h2>优世网络科技</h2>
        ...
        <div class="in-bot">
            <div class="hb-tit bb">
                ...
                <a class="more" href="<?php echo U('Home/Index/custody');?>">更多</a>
            </div>
