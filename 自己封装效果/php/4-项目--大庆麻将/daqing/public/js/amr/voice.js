        ...
        */
        RongIMVoice.init = function () {
            if (this.isIE) {
                ...
                script.src =  JSPATH + "swfobject-2.0.0.min.js";
                ...
                setTimeout(function () {
                    ...
                    swfobject.embedSWF( JSPATH + "player-2.0.2.swf", "flashContent", "1", "1", swfVersionStr, null, flashvars, params, attributes);
                }, 200);
            }
            else {
                var list = [ JSPATH + "pcmdata-2.0.0.min.js",  JSPATH + "libamr-2.0.1.min.js"];
