...
$configs= array(
		...
		'alipay_config'=>array(
			'partner' =>'2016082000300098',   //这里是你在成功申请支付宝接口后获取到的PID；
			'key'=>'
NdEYGjO7TC+CsHOtNgSnrg==',//这里是你在成功申请支付宝接口后获取到的Key
		...
		'alipay'   =>array(
			...
			'seller_email'=>'18511939314',

			//这里是异步通知页面url，提交到项目的Pay控制器的notifyurl方法；
			'notify_url'=>'http://www.xxx.com/Pay/notifyurl',

			//这里是页面跳转通知url，提交到项目的Pay控制器的returnurl方法；
			'return_url'=>'http://zscq.zai0312.com/index.php?g=Portal&m=Pay&a=returnurl',

			//支付成功跳转到的页面，我这里跳转到项目的User控制器，myorder方法，并传参payed（已支付列表）
			'successpage'=>'index.php?g=Portal&m=Pay&a=shoyintai_suc',
