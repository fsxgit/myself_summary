...
class Page {
    ...
    public function show($Tpl_Name = 'default',$con) {
        //当分页数只有1的时候，不显示
        if ($this->Total_Pages <= 1) {
            return;
        }
        return $this->Pager($this->Page_tpl [$Tpl_Name],$con);
    }
