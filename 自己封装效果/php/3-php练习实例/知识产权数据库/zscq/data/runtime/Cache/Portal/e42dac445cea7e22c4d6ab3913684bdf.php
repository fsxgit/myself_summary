        ...
        <div class="qy-xq-table oh">
            ...
            <div class="table-cont fl">
                <div class="table-box1">
                    ...
                    <div class="xinxi-box">
                        <table class="xinxi-table c333">
                            <tr>
                                ...
                                <td style="width:266px;"><?php echo ($rs["shxydm"]); ?></td>
                    ...
                    <!--主要人员 -->
                    <div class="zhu-box">
                        <div class="table-tit"><span class="tit">主要管理人员</span><span class="num">1</span> </div>
                ...
                <div class="table-box2 sb-box">
                    ...
                    <table class="sb-table">
                        ...
                        <?php if(is_array($arr1)): foreach($arr1 as $key=>$v): ?><tr>
                            ...
                            <td><?php echo ($v["markname"]); ?></td>
							<td>使用中</td>
                            <td><?php echo ($v["appdate"]); ?></td>
                            <td><?php echo ($v["markcode_key"]); ?></td>
                            <td><?php echo ($v["marktype"]); ?></td>
                    ...
                    <div class="fx_box" style="margin-top:10px;">
						...
						<div class="c-pages tc">
							<span>总记录数：<?php echo ($count); ?>&nbsp;&nbsp;,<?php echo ($totalpage); ?>页</span>
