...
INSERT INTO `cmf_auth_rule` VALUES ('162', 'test', 'admin_url', 'test/add/index', null, '添加1', '1', '');
INSERT INTO `cmf_auth_rule` VALUES ('163', 'admin', 'admin_url', 'admin/bms/lst', null, '我要报名', '1', '');
INSERT INTO `cmf_auth_rule` VALUES ('164', 'admin', 'admin_url', 'admin/bms/lists', null, '列表', '1', '');
...
-- ----------------------------
-- Table structure for `cmf_mb`
-- ----------------------------
DROP TABLE IF EXISTS `cmf_mb`;
CREATE TABLE `cmf_mb` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `specially` varchar(255) DEFAULT NULL COMMENT '专业/领域',
...
-- Records of cmf_mb
-- ----------------------------
INSERT INTO `cmf_mb` VALUES ('27', '你呢', '12358696588', '哈哈好吧', '经济和反对党', '姐姐结婚 v 风', '何厚铧', '红红火火', '会见各国共同', '回报付出的');
INSERT INTO `cmf_mb` VALUES ('28', '', '', '', '', '', '', '', '', '');
INSERT INTO `cmf_mb` VALUES ('29', '', '', '', '', '', '', '', '', '');
...
INSERT INTO `cmf_menu` VALUES ('109', '0', 'Admin', 'Setting', 'default', '', '0', '0', '设置', 'cogs', '', '0');
...
INSERT INTO `cmf_menu` VALUES ('162', '0', 'admin', 'bms', 'lst', '', '1', '1', '我要报名', '', '', '0');
INSERT INTO `cmf_menu` VALUES ('163', '162', 'admin', 'bms', 'lists', '', '1', '1', '列表', '', '', '0');
...
-- ----------------------------
INSERT INTO `cmf_users` VALUES ('1', 'admin', '###644c6e7fe0fc248fd6839b1b88d3b3e5', 'admin', '111@qq.com', '', null, '0', null, null, '111.161.7.215', '2016-08-19 10:36:47', '2016-08-11 02:17:09', '', '1', '0', '1', '0', '');
