...
<body>
<h1>所有用户信息<a href="index.html" class="shou">返回首页</a></h1>
<table>
    <tr>
        <td>编号</td>
        <td>姓名</td>
    ...
    {
        echo"<tr><td>".$row["id"]."</td><td>".$row["name"]."</td><td class='sex'>".$row["sex"]."</td><td>".$row["tel"]."</td><td>".$row["email"]."</td><td>".$row["site"]."</td><td>".$row["idCard"]."</td><td><img src='".$row["img"]."' /></td><tr>";
    }
